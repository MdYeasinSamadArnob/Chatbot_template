...
INTENTS: dict[str, IntentDefinition] = {
    ...
    # ── Conversation-act intents (no flow, classifier authority) ───────────────────
    "conversation_complete": IntentDefinition(
        name="conversation_complete",
        display_name="Conversation Complete",
        description="User signals they are satisfied, done, or have no further questions",
        profile="banking",
        flow_name=None,
        required_slots=[],
        suggested_actions=[],
    ...
    "flow_abort": IntentDefinition(
        name="flow_abort",
        display_name="Cancel Current Task",
        description="User wants to cancel or abort the current in-progress task or flow",
        profile="banking",
        flow_name=None,
        required_slots=[],
        suggested_actions=[
            {"label": "Start over", "value": "What can you help me with?"},
        ],
        examples=[
            "cancel",
            "never mind",
    ...
    "decline_current_suggestion": IntentDefinition(
        name="decline_current_suggestion",
        display_name="Decline Suggestion",
        description="User declines the bank's latest suggestion but still needs help with something else",
        profile="banking",
        flow_name=None,
        required_slots=[],
        suggested_actions=[
            {"label": "Something else", "value": "What else can you help me with?"},
        ],
        examples=[
            "no not that",
            "something else",
    ...
    "decline_escalation": IntentDefinition(
        name="decline_escalation",
        display_name="Decline Human Agent",
        description="User declines the offer to be connected to a human agent",
        profile="banking",
        flow_name=None,
        required_slots=[],
        suggested_actions=[
            {"label": "Continue with bot", "value": "Continue helping me please"},
        ],
        examples=[
            "no agent",
    ...
    "acknowledgement_only": IntentDefinition(
        name="acknowledgement_only",
        display_name="Acknowledgement",
        description="User only acknowledges the previous message with no new question",
        profile="banking",
        flow_name=None,
        required_slots=[],
        suggested_actions=[],
